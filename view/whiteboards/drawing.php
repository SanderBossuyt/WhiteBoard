<div class="leftbalk">
    ...
    <p>
        <span> Board : </span><?php echo $board['name'] ?>
    </p>
    <p>
        <span> aangemaakt op : </span><?php echo $board['creation_date'] ?>
    </p>
	...
	<form action="index.php?page=drawing&amp;id=<?php echo $_GET['id']; ?>" method="post" class="form-horizontal" id="formuploadpostit" enctype="multipart/form-data">
        ...
        <div class="input text">
            <label>
                ...
                <p class="error<?php if(empty($errors['postit'])) echo ' hidden';?>" data-for="postit">
                    Please enter your postits content
                </p>
            </label>
        </div>        
	...
	<form action="index.php?page=drawing&amp;id=<?php echo $_GET['id']; ?>" method="post" class="form-horizontal" id="formuploadvideo" enctype="multipart/form-data">
            ...
            <div class="input-text">     
                ...
                <span class="error"<?php if(empty($error['video'])) echo 'style="display: none;"';?>>
                <?php
